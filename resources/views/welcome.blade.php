        ...
        <div class="font-sans text-[#fff] mt-36 px-4 mx-4 ">
            ...
            <div class="grid lg:grid-cols-2 items-center gap-y-6 bg-blue-500 rounded-md">
                <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
                    ...
                    <p class="mt-4 text-xl leading-relaxed">WargaPeduli adalah sebuah sistem `e-gevorment` yang berfokus
                        pada tingkat rukun warga dan dibawahnya.Pada sistem ini nantinya meliputi manajemen pendataan
                        penduduk,manajemen bantuan sosial, manajemen pengaduan atau saran, dan informasi tentang
                        kegiatan pada tingkat rukun warga dan dibawahnya.Sistem ini telah melalui wawancara dari bapak
                        ketua warga dengan nama `Bapak Sukron` yang tinggal di `Jalan Kalpataru RT.04 RW.03
                        Kec.Jatimulyo Kec.Lowokwaru Kota Malang`.</p>
                </div>
                @php
                    $images = ['2.jpg', '1.jpg', '3.jpg'];
                @endphp
                <div class="lg:h-[440px] flex items-center">
                    <img id="dynamicImage" src="{{ asset($images[0]) }}" class="w-full h-full object-cover"
