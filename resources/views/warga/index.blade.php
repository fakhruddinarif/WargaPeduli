...
<div class="w-full  overflow-y-scroll"  style="background-image: url('{{ asset('1.jpg') }}'); background-size: cover;">
  ...
  <div class="flex  flex-wrap justify-center items-center  mt-14">
    <div class="bg-neutral-200 sm:grid-cols-2 items-center w-[25rem] h-[15rem] max-w-xl rounded-lg font-[sans-serif] overflow-hidden ml-2 mr-6 mt-6 transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl flex">
      ...
      <div class="px-4 py-6">
          <h3 class="text-xl font-[sans-serif] font-semibold ml-4">Pengaduan</h3>
            <p class="mt-2 text-base text-gray-600 ml-4">Laporkan Kendalamu</p>
          <div class="flex flex-wrap items-center cursor-pointer border rounded-lg w-full mt-3 ml-0">
            <div class="flex-1">
                <button id="btnpengaduan" class="text-white bg-blue-500 hover:bg-blue-600 focus:outline-none px-4 py-3 rounded-md ml-4 text-xl">Selengkapnya</button>
            </div>
          </div>
        </div>
      </div> 
    <div class="bg-neutral-200 sm:grid-cols-2 items-center w-[25rem] h-[15rem] max-w-xl rounded-lg font-[sans-serif] overflow-hidden ml-2 mr-6 mt-6 transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl flex">
      ...
      <div class="px-4 py-6">
          <h3 class="text-xl font-[sans-serif] font-semibold ml-4">Pengajuan Bansos</h3>
            <p class="mt-2 text-base text-gray-600 ml-4">Ajukan Bansos</p>
          <div class="flex flex-wrap items-center cursor-pointer border rounded-lg w-full mt-3 ml-0">
            <div class="flex-1">
               <button id="open-modal" class="text-white bg-blue-500 hover:bg-blue-600 focus:outline-none px-4 py-3 rounded-md ml-4 text-xl">Selengkapnya</button>
            </div>
          </div>
        </div>
      </div> 
    <div class="bg-neutral-200 sm:grid-cols-2 items-center w-[25rem] h-[15rem] max-w-xl rounded-lg font-[sans-serif] overflow-hidden ml-2 mr-6 mt-6 transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl flex">
      ...
      <div class="px-4 py-6">
          <h3 class="text-xl font-[sans-serif] font-semibold ml-4">Data Keluarga</h3>
            <p class="mt-2 text-base text-gray-600 ml-4">Data Keluarga</p>
          <div class="flex flex-wrap items-center cursor-pointer border rounded-lg w-full mt-3 ml-0">
            <div class="flex-1">
               <button href="#" class="text-white bg-blue-500 hover:bg-blue-600 focus:outline-none px-4 py-3 rounded-md ml-4 text-xl">Selengkapnya</button>
            </div>
          </div>
        </div>
      </div> 
