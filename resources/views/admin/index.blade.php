...
@section('content')
    <div class="w-full flex flex-row justify-center items-center gap-4">
        <div class="w-full flex flex-col justify-start items-start bg-neutral-300 px-4 py-4 rounded-lg gap-2">
            ...
            <span class="text-base font-medium text-neutral-500">Jumlah Penduduk</span>
            <span class="text-2xl font-bold text-black">2.100.800</span>
        </div>
        <div class="w-full flex flex-col justify-start items-start bg-neutral-300 px-4 py-4 rounded-lg gap-2">
            <div class="px-2 py-2 w-fit rounded-full bg-white">
