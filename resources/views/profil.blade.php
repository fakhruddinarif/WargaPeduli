                                ...
                                <table class="w-full text-sm text-left rtl:text-right bg-neutral-200">
                                    ...
                                    @foreach($pengajuan as $value)
                                        <tr class="bg-white border-b">
                                            ...
                                            <td class="px-6 py-4">{{ $value->jenis_kelamin }}</td>
        ...
        <div class="flex flex-col gap-4 justify-start items-start w-full border shadow px-4 py-4 rounded">
            @if($url == 'admin')
                <div class="flex flex-row justify-start items-center gap-2">
                    ...
                    <span class="font-semibold leading-tight tracking-tight text-neutral-900 text-2xl">
                        Detail Profil
                    </span>
                </div>
            @else
                ...
                <div class="relative flex p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow border w-full py-6 h-full">
                        ...
                        <div class="p-4 md:p-5 flex flex-col gap-2 w-full justify-start items-start">
                            <form method="POST" enctype="multipart/form-data" action="{{ url($url . '/add_warga') }}" class="w-full flex flex-col gap-4 justify-start items-start">
                                @csrf
