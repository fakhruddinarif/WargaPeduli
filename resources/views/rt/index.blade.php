...
<div class="w-full overflow-y-scroll bg-gray-300">
    ...
    <div class="flex  flex-wrap justify-center items-center">
        ...
        <div class="bg-white sm:grid-cols-2 items-center w-[20rem] h-[15rem] max-w-xl rounded-lg font-[sans-serif] overflow-hidden ml-2 mr-2 mt-6 transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl flex">
            ...
            <div class="px-4 py-6">
                <h3 class="text-xl font-[sans-serif] font-semibold">Data Penduduk</h3>
                <p class="mt-2 text-sm text-gray-600">Data Seluruh Penduduk</p>
                <div class="flex flex-wrap items-center cursor-pointer border rounded-lg w-full mt-3 ml-0">
                    <div class="flex-1">
        ...
        <div class="bg-white sm:grid-cols-2 items-center w-[20rem] h-[15rem] max-w-xl rounded-lg font-[sans-serif] overflow-hidden ml-2 mr-2 mt-6 transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl flex">
            ...
            <div class="px-4 py-6">
                <h3 class="text-xl font-[sans-serif] font-semibold">Data Keluarga</h3>
                <p class="mt-2 text-sm text-gray-600">Daftar Data Keluarga</p>
                <div class="flex flex-wrap items-center cursor-pointer border rounded-lg w-full mt-3 ml-0">
                    <div class="flex-1">
