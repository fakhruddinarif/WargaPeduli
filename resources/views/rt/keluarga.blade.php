<div id="modal-keluarga" class="hidden fixed z-40 inset-0 bg-neutral-600 bg-opacity-50 flex justify-center items-center w-full">
        <div class="bg-white rounded-xl shadow-lg w-full max-w-6xl mt-28" >
