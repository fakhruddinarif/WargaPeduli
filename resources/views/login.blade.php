...
<div class="font-[sans-serif] text-[#333] h-screen w-screen">
    <div class="min-w-screen min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-4 max-w-7xl w-full">
            ...
            <div class="border border-gray-300 rounded-md p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto  ml-20"> 
                    <div class="mb-5 ">
                    ...
                    <div class="!mt-10">
                        <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-[#0EA5E9] hover:bg-blue-800 focus:outline-none">
                            Log in
                        </button>
                    </div>
                    <p class="text-sm !mt-10 text-center">Don't have an account 
                        <a href="#" class="text-blue-600 hover:underline ml-1 whitespace-nowrap">Register here</a></p>
                </form>
            </div>
        </div>
    </div>
