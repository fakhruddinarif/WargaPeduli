...
<div class="fixed inset-0 px-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
  <div class="w-full max-w-md bg-white shadow-lg rounded-md px-5 py-10 relative mx-auto text-center">
    ...
    <div class="mt-8">
      <h3 class="text-2xl font-semibold flex-1">Pengajuan Akun Anda Diterima</h3>
      <p class="text-xl text-gray-500 mt-2"> Mohon Ingat Username<br/>
        dan Password anda</p>
      <button type="button"
        class="px-6 py-2.5 mt-8 w-full rounded text-white text-sm font-semibold border-none outline-none bg-blue-500 hover:bg-blue-600">Got
        it</button>
    </div>
  </div>
</div>
