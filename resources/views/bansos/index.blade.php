    ...
    <div class="w-full flex flex-row justify-between items-center">
        <form>
            <div class="relative justify-between items-center">
                <input type="search" id="search-dropdown" class="block px-4 py-5 w-72 z-20 text-sm text-gray-900 bg-white rounded-lg border-2" placeholder="Cari Nama" required />
        ...
        <div class="flex justify-center items-center w-fit h-fit rounded-lg bg-[#0EA5E9]">
            <a href="{{ url('bansos/create') }}" class="py-3 px-10">
